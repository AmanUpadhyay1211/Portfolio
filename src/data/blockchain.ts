...
export const blockchainProjects: Project[] = [
{
    ...
    imageUrl: 'https://res.cloudinary.com/amanupadhyay1211/image/upload/v1749749022/uatu_yhbmyh.png',
  ...
  },
  {
    ...
    imageUrl: 'https://res.cloudinary.com/amanupadhyay1211/image/upload/v1749749022/hashnipe_bnlasc.png',
